...
main :: proc() {
	...
	vertex_shader_source := #load("first_steps/shaders/triangle/vertex_shader.glsl", cstring) // vai ler o shader em tempo de compilacao
	gl.ShaderSource(vertex_shader, 1, &vertex_shader_source, nil)
	gl.CompileShader(vertex_shader)

	fragment_shader: u32
	fragment_shader = gl.CreateShader(gl.FRAGMENT_SHADER)
	fragment_shader_source := #load("first_steps/shaders/triangle/fragment_shader.glsl", cstring)
